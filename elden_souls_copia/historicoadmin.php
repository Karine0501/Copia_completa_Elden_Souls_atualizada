...
if ($total_ped <= 0) {
	...
	$consulta = $pedidopa->listar($limite,$offset);
...
if($pagina > 1){
    $voltar = $pagina - 1;
    echo "<a class='btnPagina' href='historicoadmin.php?pagina=$voltar'>❮ Anterior</a>";
}
...
if($pagina < $total_pag){
    $proxima = $pagina + 1;
    echo "<a class='btnPagina' href='historicoadmin.php?pagina=$proxima'>Próxima ❯</a>";
}
